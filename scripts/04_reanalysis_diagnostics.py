#!/usr/bin/env python3
"""Step 4: Download reanalysis data and compute R, D for sliding time windows.
...
def load_era5_from_files(ta_path, pr_path):
...
def compute_reanalysis_diagnostics(ds_ta, ds_pr, cfg, dataset_name, windows=None):
    """Compute R and D for sliding time windows from reanalysis data.
...
def main():
    ...
    logger.info("=" * 60)
    try:
        ta_path, pr_path = download_era5_cds(data_dir)
        ds_ta_era5, ds_pr_era5 = load_era5_from_files(ta_path, pr_path)
